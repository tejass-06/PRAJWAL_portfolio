    ...
    <section id="achievements" className={`py-24 px-4 relative overflow-hidden transition-colors duration-300 ${'bg-gray-900'}`}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Recognition & <span className="bg-gradient-to-r from-orange-600 to-orange-500 bg-clip-text text-transparent">Milestones</span>
          </motion.h2>
          ...
          >
            {certifications.map((cert, i) => (
              <motion.div
                ...
                className="p-6 rounded-xl border-2 transition-all bg-gray-700 border-orange-600 hover:shadow-lg"
              >
                ...
                <div className="flex items-center justify-between mt-4">
                  <span className="px-3 py-1 rounded-full text-xs font-semibold bg-orange-900/30 text-orange-300">
                    {cert.year}
                  </span>
                  {cert.issuer === 'Completed' && (

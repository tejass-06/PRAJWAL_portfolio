...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className={`py-20 px-4 relative overflow-hidden transition-colors duration-300 ${'bg-gray-900'}`}>
      {/* Decorative background */}
      <div className={`absolute top-0 right-0 w-80 h-80 rounded-full mix-blend-multiply filter blur-3xl opacity-10 ${'bg-blue-900'}`} />
      <div className={`absolute bottom-0 left-0 w-80 h-80 rounded-full mix-blend-multiply filter blur-3xl opacity-10 ${'bg-purple-900'}`} />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className={`text-base max-w-2xl mx-auto ${'text-gray-400'}`}
          >

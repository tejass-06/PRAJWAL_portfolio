...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className={`py-20 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${'bg-gray-800'}`}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project) => (
            <div
              key={project.id}
              className="group bg-gray-700 border border-gray-600 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 hover:border-blue-400"
            >
              {/* Thumbnail */}
